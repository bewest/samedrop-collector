 ...
 */
var ENVFILE = process.env.SAMEDROPCONFIG || './samedrop-collector.env';
dotenv.load({ path: 'samedrop-collector.env', silent: true });
console.log("ENVIRON", ENVFILE, process.env);
...
app.get('/account/whoami', passportConfig.isAuthenticated, userController.getFavorites);
app.get('/account/favorites', passportConfig.isAuthenticated, userController.getFavorites);
app.post('/account/favorites', passportConfig.isAuthenticated, userController.postFavorite);
